        ...
        with tf.Graph().as_default() as graph:
            ...
            for epoch in range(self.epoch_size):
                ...
                if (epoch + 1) % 100 == 0:
                    ...
                    rec_loss = self.sess.run(self.comp_net.reconstruction_error(input, x_dash),
                                             feed_dict={input: x, drop: 0})
                    print(" epoch {}/{} : loss = {:.3f}; rec_loss = {:.3f}".format(epoch + 1, self.epoch_size, loss_val,
                                                                                   rec_loss))
